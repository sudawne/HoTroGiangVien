...
@section('content')
    <div class="max-w-[1400px] mx-auto flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {{-- Card 1 --}}
            <div class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded p-4 flex flex-col justify-between h-28 shadow-sm hover:shadow-md transition-shadow">
            ...
            {{-- Card 2 --}}
            <div class="bg-white dark:bg-[#1e1e2d] border border-red-100 dark:border-red-900/30 rounded p-4 flex flex-col justify-between h-28 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
                <div class="absolute right-0 top-0 w-16 h-16 bg-red-50 dark:bg-red-900/10 rounded-bl-full -mr-4 -mt-4"></div>
                <div class="flex justify-between items-start relative z-10">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Cảnh cáo học tập</p>
            ...
            <div class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded p-4 flex flex-col justify-between h-28 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Chưa đóng học phí</p>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-[#1e1e2d] p-3 rounded border border-slate-200 dark:border-slate-700 shadow-sm">
            <div class="flex items-center gap-2 w-full md:w-auto">
                ...
                <button class="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-700 rounded text-slate-500 hidden md:block" title="Refresh">
            ...
            <div class="grid grid-cols-2 sm:flex gap-2 w-full sm:w-auto">
                <button
                    ...
                    <span class="material-symbols-outlined !text-[18px] text-green-600">table_view</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded flex flex-col shadow-sm overflow-hidden">
                <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/30">
                    ...
                    <a class="text-xs font-medium text-primary hover:text-primary/80 whitespace-nowrap ml-2" href="#">Xem tất cả</a>
                </div>
                ...
                {{-- Pagination --}}
                <div class="px-4 py-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/30 flex items-center justify-between">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded p-4 flex flex-col shadow-sm">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="font-bold text-slate-800 dark:text-white flex items-center gap-2">
                            <span class="material-symbols-outlined text-orange-500 !text-[20px]">campaign</span>
                            Thông báo mới
                        </h3>
                        <a class="text-[10px] text-slate-400 hover:text-primary uppercase font-bold tracking-wider" href="#">Xem hết</a>
                    </div>
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-3 items-start pb-3 border-b border-slate-100 dark:border-slate-800 last:border-0 last:pb-0">
                            <div class="mt-1 min-w-1.5 h-1.5 rounded-full bg-primary"></div>
                            <div>
                                <p class="text-sm font-medium text-slate-800 dark:text-slate-200 leading-snug">Nhắc nhở đăng ký tín chỉ HK2</p>
                        ...
                        <div class="flex gap-3 items-start pb-3 border-b border-slate-100 dark:border-slate-800 last:border-0 last:pb-0">
                            ...
                            <div>
                                <p class="text-sm font-medium text-slate-800 dark:text-slate-200 leading-snug">Hạn nộp hồ sơ xét học bổng</p>
                         ...
                         <div class="flex gap-3 items-start pb-3 border-b border-slate-100 dark:border-slate-800 last:border-0 last:pb-0">
                            <div class="mt-1 min-w-1.5 h-1.5 rounded-full bg-slate-300"></div>
                            <div>
                                <p class="text-sm font-medium text-slate-800 dark:text-slate-200 leading-snug">Kết quả đánh giá rèn luyện đợt 1</p>
                ...
                <div class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded p-4 flex flex-col shadow-sm flex-1">
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-3 bg-slate-50 dark:bg-slate-800/50 p-2 rounded border border-slate-100 dark:border-slate-800">
                            <div class="flex flex-col items-center justify-center bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded px-2 py-1 min-w-[50px]">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-bold text-slate-800 dark:text-slate-200 truncate">Họp lớp định kỳ tháng 5</p>
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="text-[10px] bg-slate-200 dark:bg-slate-600 px-1.5 py-0.5 rounded text-slate-600 dark:text-slate-300">09:00 AM</span>
