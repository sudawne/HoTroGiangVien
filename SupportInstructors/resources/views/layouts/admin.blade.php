...
<body class="bg-background-light dark:bg-background-dark text-slate-800 dark:text-gray-100 font-display text-sm antialiased overflow-hidden"
    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div x-show="sidebarOpen" 
             ...
             class="fixed inset-0 bg-slate-900/80 z-20 lg:hidden"
             x-cloak>
        </div>
