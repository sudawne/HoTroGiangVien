<aside
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 flex flex-col gap-1">
        ...
        <a class="flex items-center gap-3 px-3 py-2 rounded transition-colors
         {{ request()->routeIs('admin.training-point.*') ? 'bg-primary/10 text-primary' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white' }}"
            href="{{ route('admin.training-point.index') }}">
