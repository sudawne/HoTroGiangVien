                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700 text-sm">
                        @foreach ($previewData as $row)
                            <tr
                                class="{{ $row['status'] == 'error' ? 'bg-red-50 dark:bg-red-900/10' : 'hover:bg-slate-50 dark:hover:bg-slate-800/50' }} transition-colors">
                                <td
                                    class="px-4 py-3 font-medium {{ $row['status'] == 'error' ? 'text-red-600' : 'text-primary' }}">
                                    {{ $row['mssv'] }}
                                </td>
