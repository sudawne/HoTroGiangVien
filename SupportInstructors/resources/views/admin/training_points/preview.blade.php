    ...
    <div class="flex flex-col h-[calc(100vh-100px)]">
        ...
        <div class="flex justify-between items-center mb-4 px-4 pt-4">
            <div>
                ...
                <p class="text-sm text-slate-500">Chỉ những dòng <span class="text-emerald-600 font-bold">Hợp lệ</span> mới
                    được lưu vào hệ thống.</p>
            </div>
            ...
            <form action="{{ route($routePrefix . 'training_points.store_import') }}" method="POST">
                ...
                <div class="flex gap-2">
                    <a href="{{ route($routePrefix . 'training_points.import') }}"
                        class="px-4 py-2 border border-slate-300 rounded-sm text-slate-600 hover:bg-slate-50 text-sm font-bold">
                        Quay lại
                    </a>
                    <button type="submit"
                        class="px-4 py-2 bg-primary text-white rounded-sm hover:bg-primary/90 text-sm font-bold shadow-md flex items-center gap-2">
                                    ...
                                    @else
                                        <div class="flex flex-col">
                                            <span class="flex items-center gap-1 text-red-600 text-xs font-bold">
                                                <span class="material-symbols-outlined text-[16px]">cancel</span> Không thể
                                                thêm
                                            </span>
