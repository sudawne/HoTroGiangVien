...
@section('content')
            ...
            <div
                    ...
                    <table class="w-full text-left border-collapse min-w-[700px]">
                        ...
                        <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-4 py-2.5 font-mono text-slate-600 dark:text-slate-300 text-xs">22082006073
                                </td>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-4 py-2.5 font-mono text-slate-600 dark:text-slate-300 text-xs">22082006095
                                </td>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-4 py-2.5 font-mono text-slate-600 dark:text-slate-300 text-xs">22082006204
                                </td>
                                <td class="px-4 py-2.5 font-medium text-slate-800 dark:text-slate-200">Trần Tô Khánh Nguyên
                                </td>
                                <td class="px-4 py-2.5 text-slate-500 text-xs">B022TT2</td>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-4 py-2.5 font-mono text-slate-600 dark:text-slate-300 text-xs">22082006212
                                </td>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                <td class="px-4 py-2.5 font-mono text-slate-600 dark:text-slate-300 text-xs">22082006193
                                </td>
                                <td class="px-4 py-2.5 font-medium text-slate-800 dark:text-slate-200">Phạm Thị Mỹ Quyên
                                </td>
                ...
                <div
                    ...
                    <div class="flex gap-1 ml-auto sm:ml-0">
                        ...
                        <button
                            class="px-2.5 py-1 text-xs rounded hover:bg-slate-200 text-slate-600 font-medium">2</button>
                        <button
                            class="px-2.5 py-1 text-xs rounded hover:bg-slate-200 text-slate-600 font-medium">3</button>
    ...
    {{-- Nhúng cục chat trực tiếp vào đây để đảm bảo nó hiển thị trên trang này --}}
