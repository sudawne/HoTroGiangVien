    ...
    <table>
        ...
        <tr>
            <td colspan="7" style="text-align: center; font-size: 16pt; font-weight: bold;">
                DANH SÁCH SINH VIÊN BỊ CẢNH BÁO HỌC TẬP
            </td>
        </tr>
        <tr>
        ...
        <thead>
            <tr>
                ...
                <th style="font-weight: bold; border: 1px solid #000000; text-align: center; width: 150px;">Mức cảnh báo
                </th>
                <th style="font-weight: bold; border: 1px solid #000000; text-align: center; width: 100px;">TBHK</th>
                <th style="font-weight: bold; border: 1px solid #000000; text-align: center; width: 250px;">Lý do</th>
            </tr>
        </thead>
            ...
            @foreach ($data as $index => $warning)
                <tr>
                    ...
                    <td style="text-align: center; border: 1px solid #000000;">
                        {{ $warning->student->student_code ?? 'N/A' }}</td>
                    <td style="text-align: left; border: 1px solid #000000;">{{ $warning->student->fullname ?? 'N/A' }}
                    </td>
                    <td style="text-align: center; border: 1px solid #000000;">
                        {{ $warning->student->studentClass->code ?? 'N/A' }}</td>

                    <td
                        style="text-align: center; border: 1px solid #000000; font-weight: bold; {{ $warning->warning_level >= 3 ? 'color: #dc2626;' : '' }}">
                    ...
                    <td style="text-align: left; border: 1px solid #000000;">{{ $warning->reason }}</td>
                </tr>
            @endforeach
        </tbody>
