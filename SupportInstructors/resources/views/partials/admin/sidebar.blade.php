...
>
    {{-- LOGO --}}
    <div class="h-16 flex items-center justify-between px-5 border-b border-slate-100 dark:border-slate-800 flex-shrink-0">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Đại học Khoa học</p>
            </div>
        </div>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 flex flex-col gap-1">
        ...
        <a class="flex items-center gap-3 px-3 py-2 rounded transition-colors group
            ...
            <span class="material-symbols-outlined !text-[20px] font-medium"
                data-weight="{{ request()->routeIs('admin.dashboard') ? 'fill' : 'regular' }}">dashboard</span>
            <span class="font-semibold text-sm">Tổng quan</span>
        </a>

        {{-- QUẢN LÝ --}}
        <div class="pt-2 pb-1 px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Quản lý</div>
        ...
        {{-- TƯƠNG TÁC --}}
        <div class="pt-2 pb-1 px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider">Tương tác</div>
        ...
        <div class="mt-auto pt-4 border-t border-slate-100 dark:border-slate-800 relative group">
            ...
            <div class="absolute bottom-full left-0 w-full mb-2 bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg overflow-hidden invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200">
                <a href="#"
            ...
            <button class="flex items-center gap-3 w-full p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-left">
                ...
                <span class="material-symbols-outlined text-slate-400 !text-[20px]">expand_less</span>
            </button>
        </div>
    </nav>
</aside>