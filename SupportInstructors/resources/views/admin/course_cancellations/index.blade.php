        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Tổng lượt
                        xóa</p>
                    <span class="bg-red-50 text-red-600 p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">remove_circle</span></span>
                </div>
            ...
            <div
                class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded-sm p-4 flex flex-col justify-between h-24 shadow-sm">
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Số SV bị ảnh
                        hưởng</p>
                    <span class="bg-blue-50 text-blue-600 p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">person_off</span></span>
                </div>
            ...
            <div
                class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded-sm p-4 flex flex-col justify-between h-24 shadow-sm">
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Môn học liên
                        quan</p>
                    <span class="bg-orange-50 text-orange-600 p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">menu_book</span></span>
                </div>
                {{-- Nếu bạn có thống kê số môn unique thì hiện, ko thì hiện tổng --}}
                <h2 class="text-3xl font-bold text-slate-800 dark:text-white">{{ number_format($cancellations->total()) }}
                </h2>
            </div>
        </div>
