...
<head>
    ...
    {{-- Thư viện Select (Dự phòng giống Admin) --}}
    <link href="https://cdn.jsdelivr.net/npm/tom-select@2.2.2/dist/css/tom-select.bootstrap5.min.css" rel="stylesheet">
    <script src="https://cdn.jsdelivr.net/npm/tom-select@2.2.2/dist/js/tom-select.complete.min.js"></script>

    {{-- Cấu hình Tailwind chuẩn Admin --}}
    <script id="tailwind-config">
        tailwind.config = {
            ...
            theme: {
                extend: {
                    colors: {
                        "primary": "#463acb", // Màu xanh tím của admin
    ...
    <style>
        ...
        /* Tiện ích ẩn thanh cuộn riêng của sinh viên */
...
{{-- Gắn AlpineJS x-data="{ sidebarOpen: false }" để điều khiển Sidebar trên Mobile --}}
...
<body
    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        {{-- Lớp phủ nền mờ khi mở Sidebar trên điện thoại --}}
        ...
        {{-- GỌI SIDEBAR CỦA SINH VIÊN --}}
        @include('partials.student.sidebar')

        {{-- KHU VỰC NỘI DUNG CHÍNH (Chiếm phần còn lại bên phải) --}}
        <main class="flex-1 flex flex-col h-full overflow-hidden relative w-full transition-all duration-300">

            {{-- GỌI HEADER CỦA SINH VIÊN (Chứa nút đóng mở Sidebar Mobile và thanh Search) --}}
