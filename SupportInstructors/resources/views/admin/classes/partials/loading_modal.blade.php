{{-- MODAL LOADING --}}
<div id="loadingModal" class="fixed inset-0 z-[100] hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    {{-- Backdrop mờ --}}
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div
                ...
                <div class="px-4 pb-4 pt-5 sm:p-6 text-center">
                    ...
                    <h3 class="text-lg font-bold leading-6 text-slate-900 dark:text-white mb-2" id="modal-title">
                        Đang xử lý dữ liệu
                    </h3>
                    <div class="mt-2">
                        <p class="text-sm text-slate-500 dark:text-slate-400">
                            Hệ thống đang tạo lớp, khởi tạo tài khoản sinh viên và gửi email tự động.
                        </p>
