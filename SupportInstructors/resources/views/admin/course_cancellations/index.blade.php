    ...
    <div class="max-w-[1400px] mx-auto" x-data="{ showExportModal: false }">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.course_cancellations.import') }}" class="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-sm font-medium transition-all shadow-sm text-sm">
