...
@section('content')
    <div class="max-w-[1400px] mx-auto" x-data="{ showExportModal: false }">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {{-- Card 1: Tổng số --}}
            <div
                class="bg-white dark:bg-[#1e1e2d] border border-slate-200 dark:border-slate-700 rounded-sm p-4 flex flex-col justify-between h-28 shadow-sm">
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Tổng số cảnh
                        báo</p>
                    <span class="bg-primary/10 text-primary p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">warning</span></span>
                </div>
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Cảnh báo mức
                        1</p>
                    <span
                        class="bg-yellow-50 dark:bg-yellow-500/10 text-yellow-600 dark:text-yellow-500 p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">info</span></span>
                </div>
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Cảnh báo mức
                        2</p>
                    <span
                        class="bg-orange-50 dark:bg-orange-500/10 text-orange-600 dark:text-orange-500 p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">assignment_late</span></span>
                </div>
                <div class="flex items-end gap-2">
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <p class="text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide">Nguy cơ thôi
                        học</p>
                    <span class="bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-500 p-1 rounded-sm"><span
                            class="material-symbols-outlined !text-[15px]">dangerous</span></span>
                </div>
                <div class="flex items-end gap-2">
            ...
            <form id="filterForm" method="GET">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="{{ route($routePrefix . 'academic_warnings.import') }}"
                ...
                <div id="filterPanel"
                    class="{{ request()->hasAny(['semester_id', 'level', 'class_id']) ? '' : 'hidden' }} mt-4 pt-4 border-t border-slate-100 dark:border-slate-700">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <div class="relative group">
                            ...
                            <select name="level"
                                ...
                                <option value="3" {{ request('level') == '3' ? 'selected' : '' }}>Buộc thôi học
                                </option>
                            </select>
                        </div>
                        <div class="relative group">
        ...
        <div x-show="showExportModal"
            ...
            <div class="bg-white dark:bg-[#1e1e2d] rounded-lg shadow-xl w-full max-w-lg overflow-hidden"
                ...
                <form action="{{ route($routePrefix . 'academic_warnings.export') }}" method="GET" class="p-6">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            {{-- Chọn Mức cảnh báo --}}
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Mức cảnh
                                    báo</label>
                                <select name="level"
                                    class="w-full bg-slate-50 dark:bg-slate-800 border-slate-300 dark:border-slate-600 rounded-sm text-sm focus:ring-primary focus:border-primary">
                                    <option value="">-- Tất cả --</option>
